...
namespace Services
{
    class QuestService : Singleton<QuestService>, IDisposable
    {
        ...
        public void Dispose()
        {
            MessageDistributer.Instance.Unsubscribe<QuestListResponse>(this.OnQuestList);
        ...
        public bool SendQuestList()
        {
            return false;
        }
        private void OnQuestList(object sender, QuestListResponse message)
        {
